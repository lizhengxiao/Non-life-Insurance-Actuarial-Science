...
- 寿险业务的保险风险通常包括损失风险的风险（死亡、伤残）、费用风险和退保风险。

- 非寿险业务通常指财产险业务，通常为短期险种，主要包括保险期间为一年或一年以内的短期意外险、短期健康险和短期寿险。保险风险通常包括保费以及准备金风险、巨灾风险。


因此，风险造成损失的不确定性，通常用随机变量来表示。在保险风险度量中，风险可以是：
...
从统计学/保险精算的视角来看，风险造成损失的不确定性，可以用随机变量来表示。
